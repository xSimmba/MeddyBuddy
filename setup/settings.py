...
MONGO_DB_NAME = config("MONGO_DB_NAME", cast=str, default="mongo")
MONGO_HOST = config("MONGO_HOST", cast=str, default="mongo")
MONGO_PORT = config("MONGO_PORT", cast=int, default=27017)
MONGO_USER = config("MONGO_USER", cast=str, default="root")
